...
use std::collections::{BTreeMap, HashMap}; // Assuming B256Map is defined in the `reth_interfaces` crate
...
fn test_empty_state_root() {
    ...
    let post_state = HashedPostState { accounts: B256Map::default(), storages: B256Map::default() };
